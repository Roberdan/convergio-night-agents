# convergio-night-agents

[![CI](https://github.com/Roberdan/convergio-night-agents/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-night-agents/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-night-agents/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-night-agents] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-night-agents = { git = "https://github.com/Roberdan/convergio-night-agents", tag = "v0.1.0" }
```
